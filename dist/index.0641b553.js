...
async function getOneCountry() {
    try {
        const response = await (0, _axiosDefault.default).get(`https://restcountries.com/v2/name/${searchedCountry.value}`);
...
function allCurrency(currentCurrency) {
    if (currentCurrency > 0) currentCurrency.map((currency)=>{});
}
...
var Buffer = require("967d50de0e324d2a").Buffer;
"use strict";
/**
...
},{"967d50de0e324d2a":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("eb427146427789bf");
var ieee754 = require("747c1680bf38c488");
...
},{"eb427146427789bf":"eIiSV","747c1680bf38c488":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
